...
<div class="fw-bg-white fw-shadow fw-rounded fw-sm:rounded-lg fw-mb-4">
    <div class="">
        ...
        <div class="fw-mt-2 fw-px-4 fw-py-4 fw-fw-sm:p-6 fw-text-sm fw-text-gray-500">
            ...
            <div class="fw-flex fw-w-full fw-mb-4 fw-gap-3 fw-items-center">
                <div class="fw-w-2/3">
                    <dl class="fw-m-0 fw-mt-2">
                        <div class="fw-flex fw-w-full">
                            <dt class="fw-font-medium fw-text-gray-900 sm:fw-w-32 sm:fw-flex-none sm:fw-pr-6">Hit Rate</dt>
                            <dd><?php echo number_format( $status['opcache_statistics']['opcache_hit_rate'], 2 ) . '%'; ?></dd>
                        </div>

                        <div class="fw-flex">
                            <dt class="fw-font-medium fw-text-gray-900 sm:fw-w-32 sm:fw-pr-6">Cached Scripts</dt>
                            <dd><?php echo $status['opcache_statistics']['num_cached_scripts']; ?></dd>
                        </div>

                        <div class="fw-flex">
                            <dt class="fw-font-medium fw-text-gray-900 sm:fw-w-32 sm:fw-pr-6">Memory</dt>
                        ...
                        <div class="fw-flex">
                            <dt class="fw-font-medium fw-text-gray-900 sm:fw-w-32 sm:fw-pr-6">Keys</dt>
                            <dd><?php echo sprintf( '%d of %d', $status['opcache_statistics']['num_cached_keys'], $status['opcache_statistics']['max_cached_keys'] ); ?></dd>
                        </div>

                        <div class="fw-flex">
                            <dt class="fw-font-medium fw-text-gray-900 sm:fw-w-32 sm:fw-pr-6">Engine</dt>
