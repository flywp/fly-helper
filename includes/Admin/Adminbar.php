...
class Adminbar {
    ...
    public function admin_bar_menu( $wp_admin_bar ) {
        ...
        $style = 'background-position: 0 6px; color: #fff; background-repeat: no-repeat;background-size: 20px;float: left;height: 30px;width: 26px; background-image: url(data:image/svg+xml,' . rawurlencode( $logo ) . ');';
